...
const BookingStaff = () => {
  ...
  useEffect(() => {
    if (query.packageid) {
      fetch(`http://localhost:8080/api/tours/${query.packageid}`)
              ...
              <div className="flex items-center gap-5 mx-5 mt-5">
                ...
                <div className="grid grid-cols-2 gap-3 p-[19px] border border-gray-300 rounded-lg w-2/5">
                  ...
                  <Popover>
                    ...
                    <PopoverContent>
                      {/* Implement Guest Component here */}
                    </PopoverContent>
                  </Popover>
                </div>
              </div>
              <div className="border border-gray-300 rounded-2xl mx-5 mt-5 p-4 px-6">
                <div className="flex flex-col space-y-3">
                  <div className="flex justify-between">
                    <span>${tour.price} x {tour.groupsize}</span>
                    <span>${tour.price * tour.groupsize}</span>
                  </div>
                  <hr />
