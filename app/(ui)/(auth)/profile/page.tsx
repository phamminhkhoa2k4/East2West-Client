...
const Profile = () => {
    return (
      <div className="mt-40  mb-10">
        <div className="overflow-hidden rounded-[10px] shadow-md bg-white border mx-auto w-2/4">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              <h3 className="mb-1 text-heading-6 font-bold ">Wisdom Pham</h3>
              <p className="font-medium">Pham minh khoa</p>
              <p className="font-medium">Khoapham@gmail.com</p>
              <p className="font-medium">070544560654</p>
              ...
              <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-3 rounded-[5px] border border-stroke py-[9px] shadow-1 ">
                ...
                <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                  <span className="font-medium text-dark ">2K4</span>
                  <span className="text-body-sm-sm">Year</span>
                </div>
              </div>
