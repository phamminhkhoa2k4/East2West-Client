    ...
    <>
      ...
      <div className="mt-40">
        <div className="col-span-5 xl:col-span-3">
          <div className="rounded-[10px] border border-stroke bg-white shadow-md w-3/4 mx-auto ">
              ...
              <form>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      className="resize-none w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-5 pl-13 pr-5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2  dark:focus:border-primary"
                      id="address"
                      rows={6}
                      placeholder=""
                    ></textarea>
                ...
                <div className="flex justify-end gap-3">
                  <button
                    className="flex justify-center rounded-[7px] border border-stroke px-6 py-[7px] font-medium text-dark hover:shadow-1 dark:border-dark-3 "
                    type="submit"
                  >
                    Cancel
                  </button>
