          ...
          <div className="flex w-1/2 flex-col">
            ...
            <div className="flex items-start justify-between pb-5 border-b-2">
              <div className="flex flex-col gap-2">
                ...
                <div className="text-base text-[#666]">
                  {numberOfGuests} Guest(s) (Adults: {numberOfAdults}, Children:{" "}
                  {numberOfChildren}, Infants: {numberOfInfants})
                </div>
              </div>
              <div>
                <div className="px-4 py-2 border rounded-3xl">edit</div>
            ...
            <div className="flex flex-col gap-4 pt-3">
              <SelectGroupTwo label="Payment Method" onChange={(e) => {}} value={"payment"}/>
            </div>
