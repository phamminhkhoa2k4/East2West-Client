    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center mt-36 mb-30">
        <div className="text-4xl font-semibold w-[630px]">
          Khách có thể sử dụng loại phòng tắm nào?
        </div>
        <div className="w-[630px] mt-5">
          <div className="bg-white w-full border py-4 px-10 rounded-2xl shadow-md">
            <div className="flex items-center w-full justify-between py-6 border-b-2">
              <div>
                <h3 className="font-medium text-lg">Chung</h3>
                <span className="text-[#666]">
                  Phòng tắm có đường đi đến phòng của khách và chỉ dành cho
                  khách.
                </span>
              </div>
            ...
            <div className="flex items-center w-full justify-between py-6 border-b-2">
              <div>
                <h3 className="font-medium text-lg">Riêng và khép kín</h3>
                <span className="text-[#666]">
                  Phòng tắm có đường đi đến phòng của khách và chỉ dành cho
                  khách.
                </span>
            ...
            <div className="flex items-center w-full justify-between py-6 ">
              <div>
                <h3 className="font-medium text-lg">Riêng</h3>
                <span className="text-[#666]">
                  Đó là không gian riêng nhưng cần đi qua khu vực chung, như
                  hành lang, để vào được.
                </span>
              </div>
              <div className="flex items-center gap-3">
                <button
