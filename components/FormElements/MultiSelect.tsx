...
const MultiSelect: React.FC<DropdownProps> = ({ id , placeholder, label }) => {
          ...
          <div className="relative z-20 inline-block w-full">
            <div className="relative flex flex-col items-center">
              ...
              <div className="w-full px-4">
                <div
                  className={`max-h-select absolute left-0 top-full z-1 w-full overflow-y-auto rounded bg-white shadow-1 dark:bg-dark-2 dark:shadow-card ${
                    isOpen() ? "" : "hidden"
                  }`}
                  ref={dropdownRef}
