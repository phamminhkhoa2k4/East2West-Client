...
const CustomTable: React.FC<CustomTableProps> = ({ columns, data , title ,createUrl , editUrl,detailUrl ,deleteUrl }) => {
  ...
  return (
    <div className="">
      <div className="flex my-5 items-center justify-between max-w-[1135px]">
        <Link
          href={createUrl}
          className="px-5 py-2 rounded-xl border dark:border-white"
        >
          Create New
        </Link>
        <div>
                  ...
                  {columns
                    ...
                    .map((col) => (
                      <td key={col.key} className="px-4 py-4">
                        ...
                        {col.key === "action" && ( <div className="flex items-center justify-start space-x-3.5">
                          {/* <Link
                              href={detailUrl ?? "#"}
                          ...
                          <Link href={editUrl ?? ""} className="hover:text-primary">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 24 24"
                          ...
                          <button
                            onClick={() =>
                              handleDelete(Number(row.structureid))
                            }
                            className="hover:text-primary"
                          >
                            <svg
