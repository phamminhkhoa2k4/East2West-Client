...
const TransferInfo = ({transfer}: TransferInfoType) => {
    ...
    <>
      <div>
        <div className="flex flex-col gap-2">
          <div className="font-bold text-lg">{transfer.transfername}</div>
          <div className="w-125">
            <p
          ...
          <div className="flex gap-1 items-center ">
            ...
            <p>Duration : {convertToTimeUnit(Number(transfer.transferid))} </p>
          </div>
          <div className="flex gap-1 items-center ">
            <span>
              <svg
